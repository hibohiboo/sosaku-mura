...
export async function compressAsync(data: Uint8Array, chunkSize?: number): Promise<NullableUint8Array> {
...
export async function decompressAsync(data: Uint8Array, chunkSize?: number): Promise<NullableUint8Array> {
