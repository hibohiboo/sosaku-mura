...
export class Network {
  ...
  get peerContext(): IPeerContext { return this.connection && this.connection.peerContext ? this.connection.peerContext : unknownContext; }
  ...
  private callbackUnload: any = () => { this.close(); };
